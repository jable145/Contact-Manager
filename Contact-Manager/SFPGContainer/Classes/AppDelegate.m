...
static NSString *const remoteAccessConsumerKey = @"3MVG92.uWdyphVj7CwJh9RJdcWr.q2KDvLamt550.R7SnaLIaqyy39qbGHHp9bJkNZY7wOhN83Y43zP7EdBOG";
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	if ([launchOptions objectForKey:[keyArray objectAtIndex:0]]!=nil) 
	{
		...
		NSLog(@"SFPGContainer launchOptions = %@",url);
	}
...
// only valid if SFPGContainer.plist specifies a protocol to handle
